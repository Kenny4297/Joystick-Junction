...
const GameDetails = () => {
        ...
        <div style={{display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
            <div style={{display:'flex', width:'100%', justifyContent:'space-evenly'}}>
                ...
                <div style={{
                    ...
                    <a style={{color: '#17A2B8'}} href={gameData.game_url}>Play Now!</a>
                </div>
    ...
    <Link className="button-link" to={`/games/${gameId}/Strategy-and-Tips`}>Strategy and Tips</Link>
    <Link className="button-link" to={`/games/${gameId}/Reviews-and-Opinions`}>Reviews and Opinions</Link>
    <Link className="button-link" to={`/games/${gameId}/Bugs-and-Glitches`}>Bugs and Glitches</Link>
    <Link className="button-link" to={`/games/${gameId}/Updates-Patches-DLCs`}>Updates, Patches, DLC's</Link>
    <Link className="button-link" to={`/games/${gameId}/Meetups`}>Meetups</Link>
</div>
