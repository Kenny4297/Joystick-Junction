            ...
            <div aria-labelledby="featured-games-header" className="featured-games-card">
                <Carousel interval={null} indicators={false}>
                    {games.map((game, index) => (
                        <Carousel.Item key={index} onClick={() => handleGameClick(game)} className="featured-games-carousel" aria-labelledby={`featured-game-${index}-title`} aria-describedby={`featured-game-${index}-description`}>
                            <div>
                                ...
                                <Carousel.Caption className="featured-games-carousel-caption">
                                    ...
                                    <p id={`featured-game-${index}-description`}>{game.short_description.length > 250 ? `${game.short_description.substring(0, 250)}...` : game.short_description}</p>
                                </Carousel.Caption>
                            </div>
                        </Carousel.Item>
                    ))}
