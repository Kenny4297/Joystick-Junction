...
const StrategyAndTipsMock = ({ gameId, categoryPage }) => {
    ...
    // Access the correct category of posts from the mockPosts object
    let categorizedPosts = mockPosts[categoryPage];
    ...
    if (storedData) {
        ...
        // if no data exists, generate the random posts
    ...
    }, [gameId, categoryPage]); // Don't forget to add both dependencies here
